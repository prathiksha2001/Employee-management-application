...
def checkAdminAccess(data : schemas.TokenData):
    if data.role != 'admin':
        raise HTTPException(status_code=status.HTTP_401_UNAUTHORIZED, detail="you're not allowed to access this resource")
    return True 
